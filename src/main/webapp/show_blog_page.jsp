...
<%
	...
	Post post = dao1.getPostByPid(pid);
	UserDao uDao = new UserDao(ConnectionProvider.getConnection());
	User author = uDao.getUserByUserId(post.getUserId());
				...
				<div class = "col-md-10 offset md-1	">
					<div class = "card">
						...
						<div class = "card-body">
							...
							<div class = "row my-3">
								<div class = "col-md-8">
									<p class = "post-user-info"><a href = "#"><%=author.getName()%></a> has posted :</p>
								</div>
								<div class = "col-md-4">
						...
						%>
							<a href="#" onclick="doLike(<%=post.getPid()%>,<%=user.getId() %>)" class = "btn btn-outline-primary"><i class = "fa fa-thumbs-o-up"></i><span class="like-counter"> <%=dao3.countLikeOnPost(post.getPid())%></span></a>
							<a href="profile.jsp" class = "btn btn-outline-primary">Back</a>
